...
spec_files: 
 - "minivite@1.1%gcc@6.4.0+openmp+opt arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%gcc@6.4.0 arch=linux-rhel7-power9le": spec-0.json
 - "minivite@1.1%gcc@6.4.0+openmp+opt arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%gcc@6.4.0 arch=linux-rhel7-power9le": spec-1.json
 ...
 - "minivite@1.1%xl@16.1 fflags="-qzerosize" +openmp+opt arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%xl@16.1 fflags="-qzerosize"  arch=linux-rhel7-power9le": spec-4.json
