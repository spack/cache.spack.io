...
spec_files: 
 ...
 - spec-4.json
spec_names:
 - 'amg@1.2%gcc@6.4.0~int64+openmp~optflags arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%gcc@6.4.0 arch=linux-rhel7-power9le'
 - 'amg@1.2%gcc@6.4.0~int64+openmp~optflags arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%gcc@6.4.0 arch=linux-rhel7-power9le'
 ...
 - 'amg@1.2%xl@16.1 fflags="-qzerosize" ~int64+openmp~optflags arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%xl@16.1 fflags="-qzerosize"  arch=linux-rhel7-power9le'
---