...
spec_files: 
 ...
 - "amg@1.2%xl@16.1 fflags="-qzerosize" ~int64+openmp~optflags arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%xl@16.1 fflags="-qzerosize"  arch=linux-rhel7-power9le": spec-4.json
