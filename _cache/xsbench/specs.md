...
spec_names:
 ...
 - 'xsbench@19%gcc@6.4.0+mpi+openmp arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%gcc@6.4.0 arch=linux-rhel7-power9le'
 - 'xsbench@19%xl@16.1 fflags="-qzerosize" +mpi+openmp arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%xl@16.1 fflags="-qzerosize"  arch=linux-rhel7-power9le'
