...
spec_files: 
 - "ember@1.0.0%gcc@6.4.0 arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%gcc@6.4.0 arch=linux-rhel7-power9le": spec-0.json
 ...
 - "ember@1.0.0%xl@16.1 fflags="-qzerosize"  arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%xl@16.1 fflags="-qzerosize"  arch=linux-rhel7-power9le": spec-2.json
 - "ember@1.0.0%gcc@6.4.0 arch=linux-rhel7-power9le ^spectrum-mpi@10.3.1%gcc@6.4.0 arch=linux-rhel7-power9le": spec-3.json
